...
이 학습 가이드는 **26개 챕터**를 기초 / 중급 / 고급 3단계로 나누어 다룹니다:

### 기초 (Ch 1~6)

| 장 | 주제 |
|---|---|
| 1장 | 시작하기 - 설치, Hello World, Cargo |
| 2장 | 기본 문법 - 변수, 타입, 함수, 제어 흐름 |
| 3장 | 소유권과 빌림 - Rust의 핵심 개념 |
| 4장 | 구조체 - 사용자 정의 타입 |
| 5장 | 열거형과 패턴 매칭 |
| 6장 | 컬렉션 - Vec, String, HashMap |

### 중급 (Ch 7~14)

| 장 | 주제 |
|---|---|
| 7장 | 에러 처리 - panic!, Result, ? 연산자 |
| 8장 | 제네릭 |
| 9장 | 트레이트 |
| 10장 | 라이프타임 |
| 11장 | 클로저 |
...
| 장 | 주제 |
|---|---|
| 15장 | 스마트 포인터 - Box, Rc, RefCell |
| 16장 | 동시성 - 스레드, 채널, Mutex |
| 17장 | 비동기 프로그래밍 - async/await |
| 18장 | 테스트 |
| 19장 | unsafe Rust |
| 20장 | 매크로 |
| 21장 | 타입 시스템 심화 |
...
graph LR
    subgraph 기초
        A["1~2장<br/>시작 & 문법"] --> B["3장<br/>소유권"]
        B --> C["4~6장<br/>타입 & 컬렉션"]
    end
    subgraph 중급
        C --> D["7~10장<br/>에러/제네릭/트레이트"]
        D --> E["11~14장<br/>클로저/반복자/모듈"]
    end
    subgraph 고급
        E --> F["15~18장<br/>포인터/동시성/테스트"]
        F --> G["19~26장<br/>unsafe/매크로/실전"]
    end
...
graph TD
    ...
    style CH1 fill:#e8f5e9,stroke:#4caf50
    style CH2 fill:#fff3e0,stroke:#ff9800
    style CH3 fill:#fce4ec,stroke:#e91e63
```
